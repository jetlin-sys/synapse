...
def test_refresh_room_metrics_writes_tokens_and_budget() -> None:
    ...
    assert metrics["tokens"] == 3000
    assert metrics["token_budget"] == DEFAULT_TOKEN_BUDGET
    assert DEFAULT_TOKEN_BUDGET == 2_000_000
