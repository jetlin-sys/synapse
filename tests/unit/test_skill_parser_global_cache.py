...
``synapse.skills.parser`` reuses ParsedSkill objects across
...
from synapse.skills.events import SkillEvent, notify_skills_changed
from synapse.skills.parser import (
    _GLOBAL_PARSE_CACHE,
    SkillParser,
