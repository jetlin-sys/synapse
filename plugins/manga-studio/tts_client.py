    ...
    *,
    ...
    try:
        ...
        raise VendorError(
            ...
            "dependencies from Synapse Setup Center instead of installing into host Python.\n"
    ...
    *,
    ...
    try:
        ...
        raise VendorError(
            ...
            "plugin dependencies from Synapse Setup Center instead of installing into host Python.\n"
