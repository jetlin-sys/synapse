...
"""
        ...
        system = (
            "You are the Synapse ppt-maker per-slide content engine. "
    ...
    async def compose_additional_context(
        ...
        *,
        ...
        # Optional web search using Synapse's built-in handler
...
"""
    ...
    async def _call_json(
        ...
        *,
        ...
        brain = self.get_brain()
        system = (
            "You are the Synapse ppt-maker planning engine. "
    ...
    async def _web_search_context(
        *, title: str, prompt: str, max_results: int
        ...
        if not query:
            return ""
        try:
            from synapse.tools.handlers.web_search import WebSearchHandler  # type: ignore
        except Exception:
