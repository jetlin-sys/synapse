...
synapse.relay.apply_relay_override helper underneath but each
...
# ─── Fake synapse.relay module so tests do not depend on PYTHONPATH ──
...
def test_synapse_relay_import_failure_falls_back(monkeypatch):
