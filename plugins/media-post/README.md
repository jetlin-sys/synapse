...
Synapse first-class plugin that turns an edited video into platform-ready
...
- **Synapse** ≥ 1.27.0 with SDK `>=0.7.0,<0.8.0`
...
# 3. Open Synapse → sidebar → Media Post → Settings → paste API Key → Save
