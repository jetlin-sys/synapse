...
class WebAccessConfig:
    ...
    def has_password_set(self) -> bool:
        ...
        Used by :mod:`synapse.api.setup_state` to decide whether the Setup
    ...
    def clear_password(self) -> None:
        ...
        Used by the ``synapse reset-password`` CLI. Bumps ``token_version``
...
def is_trusted_local(request: Request) -> bool:
    ...
    :mod:`synapse.api.setup_state` — keep them aligned by going through
    this single helper.
    """
