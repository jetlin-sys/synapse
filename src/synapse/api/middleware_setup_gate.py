...
When Synapse is reachable on the LAN but no web-access password has been
...
Decision delegated to :mod:`synapse.api.setup_state`. This module only
...
:func:`synapse.api.auth.create_auth_middleware`. With FastAPI's LIFO
