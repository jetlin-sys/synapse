"""Synapse built-in safety_immune paths (9 semantic categories).
...
- We want Synapse's own identity files / audit trails / scheduler state
...
6. **User credentials / keys** — SSH/GPG/AWS/cloud creds + LLM endpoint
   keys + Synapse's own user manager profiles.
