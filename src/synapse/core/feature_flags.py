...
automatically; setting an environment variable like ``SYNAPSE_FF_DISABLE``
...
_DISABLED_AT_IMPORT: set[str] = _parse_csv_env("SYNAPSE_FF_DISABLE")
_ENABLED_AT_IMPORT: set[str] = _parse_csv_env("SYNAPSE_FF_ENABLE")
