...
SYSTEM_PRESETS: list[AgentProfile] = [
    ...
    AgentProfile(
        ...
        description_i18n={
            "zh": "浩鲸需求分析专家，擅长需求拆解与分析",
            "en": "WhaleCloud Requirement Expert",
        },
    ),
    AgentProfile(
        ...
        description_i18n={
            "zh": "浩鲸产品设计专家，擅长产品架构与UI/UX设计",
            "en": "WhaleCloud Design Expert",
        },
    ),
    AgentProfile(
        ...
        description_i18n={
            "zh": "浩鲸产品研发专家，擅长代码编写与系统实现",
            "en": "WhaleCloud R&D Expert",
        },
    ),
    AgentProfile(
        ...
        description_i18n={
            "zh": "浩鲸产品测试专家，擅长自动化测试与用例编写",
            "en": "WhaleCloud Test Expert",
        },
    ),
    AgentProfile(
        ...
        description_i18n={
            "zh": "浩鲸质量管控专家，擅长流程规范与质量评估",
            "en": "WhaleCloud QA Expert",
        },
    ),
]
